...
import ArmTechDallasEvent from '../../../../src/views/ArmTechDallasEvent';

const title = 'ARMTech Dallas 2026 | DROS';
const description =
  'Join DROS at ARMTech Dallas 2026 to see how AI agents and context orchestration improve collections workflows.';
const path = '/events/2026/armtech-dallas';
