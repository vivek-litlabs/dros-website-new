...
const title = 'Events | DROS';
const description =
  'Explore upcoming and past events where DROS showcases modern collections workflows and AI-driven engagement.';
const path = '/events/armtech-rmai-2026';
