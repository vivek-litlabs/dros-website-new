...
import BookMeeting from '../../src/views/BookMeeting';

const title = 'Book a Demo | DROS AI for Collections';
const description =
  'Book a meeting with DROS to see how AI agents, account context, and workflow orchestration support collections and recovery teams.';
const path = '/book-meeting';
