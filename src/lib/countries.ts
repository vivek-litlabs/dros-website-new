// Country data for the demo-call phone inputs. Each entry is
// [name, ISO 3166-1 alpha-2, dial code without "+"]. The flag emoji is
// derived from the ISO code so it never needs to be stored.
type CountryTuple = [name: string, iso: string, dial: string];
