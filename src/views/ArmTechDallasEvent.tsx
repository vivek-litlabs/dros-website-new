export const route = '/events/2026/armtech-dallas';
import { Link } from 'react-router-dom';
import { Calendar, MapPin, ArrowRight, Users, CheckCircle2, Linkedin, BookOpen, Mail, Phone } from 'lucide-react';
import { Helmet } from 'react-helmet-async';
import Navbar from './Navbar';

export default function ArmTechDallasEvent() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Helmet>
        <title>ARMTech Dallas 2026 | DROS</title>
        <meta name="description" content="Join DROS at ARMTech Dallas 2026 to see how AI agents and context orchestration improve collections workflows." />
      </Helmet>
      <Navbar />
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          <header className="mb-12">
            <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6">
              Meet DROS at <span style={{ background: 'linear-gradient(135deg, #DD39F9, #03D2FC)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>ARMTech Dallas</span>
            </h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-4 mb-12">
              <div className="flex items-start gap-4 p-6 bg-slate-900/50 border border-slate-800 rounded-xl">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2 text-white">Meet the Founders</h3>
                  <p className="text-slate-300">
                    Talk directly with our founding team about the future of debt collection technology and how DROS can transform your operations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 bg-slate-900/50 border border-slate-800 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-slate-300">
                    See DROS and Vodex in action with live demonstrations of our AI-powered workflows and voice automation capabilities.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 bg-slate-900/50 border border-slate-800 rounded-xl">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2 text-white">Discuss Your Use Case</h3>
                  <p className="text-slate-300">
                    Learn how DROS can be tailored to your agency's specific needs and integration requirements.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-8 mb-12">
              ...
              <p className="text-xl text-slate-300 mb-6">
                Our schedule fills up quickly during conferences. Book a meeting with our team in advance to ensure we have dedicated time to discuss your specific needs.
              </p>
              <a
